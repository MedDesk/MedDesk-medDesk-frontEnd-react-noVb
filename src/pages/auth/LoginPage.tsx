    ...
    try {
      ...
      if (response.success) {
        ...
        if (allowedRoles.includes(userRole)) {
          ...
          setError("Unauthorized: Your account does not have access to this portal.");
          // Optional: Clear storage if role is invalid
          localStorage.clear();
        }
      } else {
      ...
      const errorMessage = err.response?.data?.message || "Connection error. Please try again later.";
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 w-full p-16 flex flex-col justify-between">
          ...
          <div className="glass-card bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-[32px] flex items-center gap-4 max-w-sm">
             ...
             <div>
                <p className="text-white font-bold">Encrypted Connection</p>
                <p className="text-blue-200 text-xs">Your data is protected by industry-standard SSL encryption.</p>
             </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-10">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="name@meddesk.com"
                  className="w-full bg-white border border-slate-200 rounded-2xl py-4 pl-12 pr-4 outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-600 transition-all font-medium text-slate-900 shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-white border border-slate-200 rounded-2xl py-4 pl-12 pr-12 outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-600 transition-all font-medium text-slate-900 shadow-sm"
                />
                <button 
                  type="button" 
          ...
          <div className="pt-6 text-center">
            <p className="text-slate-500 font-medium">
              New to MedDesk?{' '}
              <Link to="/Register" className="text-blue-600 font-bold hover:underline">Create admin account</Link>
            </p>
          </div>
        </div>
      </div>
